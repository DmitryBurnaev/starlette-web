...
def convert_to_field(column: Column) -> Type[BaseField]:
    ...
    raise NotSupportedColumn(f"Column {column.type} is not supported")  # pragma: no cover


def normalize_fields(fields: Sequence[Any], mapper: Mapper) -> List[BaseField]:  # noqa: C901
    """
